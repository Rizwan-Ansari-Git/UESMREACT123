...
console.log("submissionData"+  JSON.stringify(submissionData))
    try {
      const response = await Api.post('/AppControl/allowApplication', submissionData);
  ...
  return (
    ...
    <div className='row'>
                ...
                <div  style={{ marginTop: "2%", textAlign: 'center' }}><h2>Allow Application (Hash Based)</h2></div>
...
export default AllowApplication;